	...
	let WordFindGame = function() {
	  ...
	  */
	  var endTurn = function () {
		...
		for (var i = 0, len = wordList.length; i < len; i++) {
		  if (wordList[i] === curWord) {
			...
			chamaModal('popupIntro', 'aparece', curWord);
			changeImage();
		  }
	  ...
	  var changeImage = function() {
		// console.log(wordList.length, wordList_Total.length);
		let imgCount = (wordList_Total.length - wordList.length) + 1;
		$('.puzzleImage').find('img').attr('src', 'images/P1_' + imgCount + '.png');
	  }
	  ...
	  return {
		...
		*/
		create: function(words, puzzleEl, wordsEl, options) {
		  ...
		  wordList_Total =  words.slice(0).sort();
